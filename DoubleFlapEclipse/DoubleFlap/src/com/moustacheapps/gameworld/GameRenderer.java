...
public class GameRenderer {
	...
	private TextureRegion mountain, mountainf, cloud1, cloud1f, cloud2,
			...
			// mountain2, mountainf2, cloud12, cloud1f2, cloud22, cloud2f2,
			// cloud32, cloud3f2,
			grassL, grassR, birdMid, birdMid2, skullUp, skullDown,
			bar, // ready,
	...
	private void drawGrassLeft() {
		...
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
				batcher.getTransformMatrix(), left, grassScissorsRight);
	...
	public void drawPowerUp() {
		batcher.draw(powerUpAsset, powerUp.getXX(), powerUp.getY(),
	...
	public void drawMountains() {
		...
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(mountain, mountainScroll.getX(), mountainScroll.getY(),
				136, 43);
		batcher.draw(mountain, mountainScroll2.getX(), mountainScroll2.getY(),
				136, 43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
		...
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(mountainf, mountainfScroll.getX(), mountainfScroll.getY(),
				136, 43);
		batcher.draw(mountainf, mountainfScroll2.getX(),
				mountainfScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud1() {
		...
		batcher.draw(cloud1, cloud1Scroll2.getX(), cloud1Scroll2.getY(), 136,
				43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
		...
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud1f, cloud1fScroll.getX(), cloud1fScroll.getY(), 136,
				43);
		batcher.draw(cloud1f, cloud1fScroll2.getX(), cloud1fScroll2.getY(),
				136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud2() {
		...
		batcher.draw(cloud2, cloud2Scroll2.getX(), cloud2Scroll2.getY(), 136,
				43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
		...
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud2f, cloud2fScroll.getX(), cloud2fScroll.getY(), 136,
				43);
		batcher.draw(cloud2f, cloud2fScroll2.getX(), cloud2fScroll2.getY(),
				136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud3() {
		...
		batcher.draw(cloud3, cloud3Scroll2.getX(), cloud3Scroll2.getY(), 136,
				43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
		...
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud3f, cloud3fScroll.getX(), cloud3fScroll.getY(), 136,
				43);
		batcher.draw(cloud3f, cloud3fScroll2.getX(), cloud3fScroll2.getY(),
				136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
