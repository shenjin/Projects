...
public class GameRenderer {
	...
	cloud1fScroll, cloud2Scroll, cloud2fScroll, cloud3Scroll, cloud3fScroll,
	mountainScroll2, mountainfScroll2, cloud1Scroll2,
	cloud1fScroll2, cloud2Scroll2, cloud2fScroll2, cloud3Scroll2, cloud3fScroll2;


	// Game Assets
	private TextureRegion mountain, mountainf, cloud1, cloud1f, cloud2, cloud2f, cloud3, cloud3f, 
// 	mountain2, mountainf2, cloud12, cloud1f2, cloud22, cloud2f2, cloud32, cloud3f2, 
	grassL, grassR, birdMid, birdMid2, skullUp, skullDown, bar, //ready,
	zbLogo, gameOver, highScore, scoreboard, star, noStar, retry, powerUpAsset;
	...
	// Buttons
	//	private List<SimpleButton> menuButtons, difficultyButtons, difficultyButtonsHardUnlock,
	//	difficultyButtonsInsaneUnlock, retryButtons;
	private SimpleButton playButton, easyButton, hardButton, insaneButton, hardLockButton,
	insaneLockButton, shuffleButtonOn, shuffleButtonOff, shuffleLockButton, retryButton;
	private Color transitionColor;

	public Rectangle scissorsLeft, scissorsRight, left, right;

	public GameRenderer(GameWorld world, int gameHeight, int midPointY, int screenWidth, int screenHeight) {
		myWorld = world;
		...
		//				.getMenuButtons();
		//		this.difficultyButtons = ((InputHandler) Gdx.input.getInputProcessor())
		//				.getDifficultyButtons();
		//		this.difficultyButtonsHardUnlock = ((InputHandler) Gdx.input.getInputProcessor())
		//				.getDifficultyButtonsHardUnlock();
		//		this.difficultyButtonsInsaneUnlock = ((InputHandler) Gdx.input.getInputProcessor())
		//				.getDifficultyButtonsInsaneUnlock();
...
//		cloud12 = AssetLoader.cloud1;
//		cloud1f2 = AssetLoader.cloud1f;
//		cloud22 = AssetLoader.cloud2;
//		cloud2f2 = AssetLoader.cloud2f;
//		cloud32 = AssetLoader.cloud3;
//		cloud3f2 = AssetLoader.cloud3f;
	...
	private void drawGrassLeft() {


		// Draw the grass
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), left, scissorsLeft);
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(grassL, frontGrassL.getX(), frontGrassL.getY(),
				frontGrassL.getWidth(), frontGrassL.getHeight());
		batcher.draw(grassL, backGrassL.getX(), backGrassL.getY(),
				backGrassL.getWidth(), backGrassL.getHeight());
		batcher.flush();
	...
	private void drawGrassRight() {

		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), right, scissorsRight);
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(grassR, frontGrassR.getX(), frontGrassR.getY(),
				frontGrassR.getWidth(), frontGrassR.getHeight());
		batcher.draw(grassR, backGrassR.getX(), backGrassR.getY(),
				backGrassR.getWidth(), backGrassR.getHeight());
		batcher.flush();
	...
	private void drawSkullsRight() {
		...
		batcher.draw(skullDown, pipe1.getX() - 1,
				pipe1.getY() + pipe1.getHeight() + pipe1.getGapSpace(), 24, 14);
	...
	public void drawPowerUp() {
		batcher.draw(powerUpAsset, powerUp.getXX(), powerUp.getY(), powerUp.getWidth(), powerUp.getHeight());
	}
	...
	public void drawMountains() {
		...
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(mountain, mountainScroll.getX(), mountainScroll.getY(), 136, 43);
		batcher.draw(mountain, mountainScroll2.getX(), mountainScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), left, scissorsLeft);
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(mountainf, mountainfScroll.getX(), mountainfScroll.getY(), 136, 43);
		batcher.draw(mountainf, mountainfScroll2.getX(), mountainfScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud1() {
		...
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(cloud1, cloud1Scroll.getX(), cloud1Scroll.getY(), 136, 43);
		batcher.draw(cloud1, cloud1Scroll2.getX(), cloud1Scroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), left, scissorsLeft);
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud1f, cloud1fScroll.getX(), cloud1fScroll.getY(), 136, 43);
		batcher.draw(cloud1f, cloud1fScroll2.getX(), cloud1fScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud2() {
		...
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(cloud2, cloud2Scroll.getX(), cloud2Scroll.getY(), 136, 43);
		batcher.draw(cloud2, cloud2Scroll2.getX(), cloud2Scroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), left, scissorsLeft);
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud2f, cloud2fScroll.getX(), cloud2fScroll.getY(), 136, 43);
		batcher.draw(cloud2f, cloud2fScroll2.getX(), cloud2fScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	public void drawCloud3() {
		...
		ScissorStack.pushScissors(scissorsRight);
		batcher.flush();
		batcher.draw(cloud3, cloud3Scroll.getX(), cloud3Scroll.getY(), 136, 43);
		batcher.draw(cloud3, cloud3Scroll2.getX(), cloud3Scroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight, batcher.getTransformMatrix(), left, scissorsLeft);
		ScissorStack.pushScissors(scissorsLeft);
		batcher.flush();
		batcher.draw(cloud3f, cloud3fScroll.getX(), cloud3fScroll.getY(), 136, 43);
		batcher.draw(cloud3f, cloud3fScroll2.getX(), cloud3fScroll2.getY(), 136, 43);
		batcher.flush();
		ScissorStack.popScissors();
	}
	...
	private void drawPipesRight() {
		...
		batcher.draw(bar, pipe1.getX(), pipe1.getY(), pipe1.getWidth(),
				pipe1.getHeight());
		batcher.draw(bar, pipe1.getX(), pipe1.getY() + pipe1.getHeight() + pipe1.getGapSpace(),
				pipe1.getWidth(), midPointY + 66 - (pipe1.getHeight() + pipe1.getGapSpace()));

		batcher.draw(bar, pipe2.getX(), pipe2.getY(), pipe2.getWidth(),
				pipe2.getHeight());
		batcher.draw(bar, pipe2.getX(), pipe2.getY() + pipe2.getHeight() + pipe1.getGapSpace(),
				pipe2.getWidth(), midPointY + 66 - (pipe2.getHeight() + pipe1.getGapSpace()));

		batcher.draw(bar, pipe3.getX(), pipe3.getY(), pipe3.getWidth(),
				pipe3.getHeight());
		batcher.draw(bar, pipe3.getX(), pipe3.getY() + pipe3.getHeight() + pipe1.getGapSpace(),
				pipe3.getWidth(), midPointY + 66 - (pipe3.getHeight() + pipe1.getGapSpace()));
		batcher.flush();
	...
	private void drawPipesLeft() {
		...
		batcher.draw(bar, pipeA.getX(), pipeA.getY(), pipeA.getWidth(),
				pipeA.getHeight());
		batcher.draw(bar, pipeA.getX(), pipeA.getY() + pipeA.getHeight() + pipe1.getGapSpace(),
				pipeA.getWidth(), midPointY + 66 - (pipeA.getHeight() + pipe1.getGapSpace()));

		batcher.draw(bar, pipeB.getX(), pipeB.getY(), pipeB.getWidth(),
				pipeB.getHeight());
		batcher.draw(bar, pipeB.getX(), pipeB.getY() + pipeB.getHeight() + pipe1.getGapSpace(),
				pipe2.getWidth(), midPointY + 66 - (pipeB.getHeight() + pipe1.getGapSpace()));

		batcher.draw(bar, pipeC.getX(), pipeC.getY(), pipeC.getWidth(),
				pipeC.getHeight());
		batcher.draw(bar, pipeC.getX(), pipeC.getY() + pipeC.getHeight() + pipe1.getGapSpace(),
				pipeC.getWidth(), midPointY + 66 - (pipeC.getHeight() + pipe1.getGapSpace()));
		batcher.flush();
	...
	private void drawBird(float runTime) {
		...
		if (bird2.shouldntFlap()) {
			batcher.draw(birdMid2, bird2.getX(), bird2.getY(),
					...
					bird2.getWidth(), bird2.getHeight(), 1, 1, bird2.getRotation());	
	...
	private void drawMenuUI() {
		batcher.draw(zbLogo, 272 / 2 - ((zbLogo.getRegionWidth() / 1.2f) / 2.0f), midPointY - 40,
	...
	private void drawShuffleUI(){
		if (InputHandler.getShuffleState() == 0) {
			...
			AssetLoader.whiteFont.draw(batcher, "Shuffle is off", 136 - (2.5f * 10), midPointY + 59);
		} else {
			shuffleButtonOn.draw(batcher);
			AssetLoader.whiteFont.draw(batcher, "Shuffle is  on", 136 - (2.5f * 10), midPointY + 59);
		}
	}
	...
	private void drawLives() {
		AssetLoader.whiteFont.draw(batcher, "" + GameWorld.getLives(),
				5,5);
	}
	...
	private void drawUnlockShuffle(){
		if (GameWorld.getGamesNeeded() == 10) {
			AssetLoader.whiteFont.draw(batcher, "" + "Play " + GameWorld.getGamesNeeded() + " Games",
