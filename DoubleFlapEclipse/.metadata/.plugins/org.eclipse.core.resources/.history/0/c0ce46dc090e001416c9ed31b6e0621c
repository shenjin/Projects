...
public class AssetLoader {
	...
	public static TextureRegion logo, zbLogo, mountain, cloud1, cloud2, cloud3, mountainf, cloud1f, cloud2f, cloud3f, grassL, grassR, bird, birdDown,
			birdUp, bird2, birdDown2, birdUp2, skullUp, skullDown, bar, playButtonUp, playButtonDown, easyButtonUp, easyButtonDown,
			hardButtonUp, hardButtonDown, xxxxButtonUp, xxxxButtonDown, hardButtonLockUp, hardButtonLockDown, xxxxButtonLockUp,
			xxxxButtonLockDown, backButtonUp, backButtonDown, powerUp, shuffleButtonLockedUp, shuffleButtonOffUp, shuffleButtonOnUp,
			 shuffleButtonLockedDown, shuffleButtonOffDown, shuffleButtonOnDown, ready, gameOver, highScore, scoreboard, star, noStar, retry;
	public static Animation birdAnimation, birdAnimation2, bgAnimation, bgfAnimation;
